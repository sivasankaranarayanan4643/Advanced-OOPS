...
namespace CarModel
{
    public class Eco:Car,IBrand
    {
        ...
        public Eco(string fuelType,int numberOfSeats,string color,int tankCapacity,double numberOfKmDriven,string engineNumber,string chasisNumber):base(fuelType,numberOfSeats,color,tankCapacity,numberOfKmDriven)
        {
            s_makingID++;
